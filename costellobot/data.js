    ...
    "Costellobot": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8097294391762d84ccdfdf9db1dfd59d3b8f390c",
          "message": "Consume .NET daily builds\n\nUpdate to the latest daily build of .NET 9.",
          "timestamp": "2024-08-13T16:31:16Z",
          "tree_id": "251112384e2c8840c105e4795e02622fdace05ae",
          "url": "https://github.com/martincostello/costellobot/commit/8097294391762d84ccdfdf9db1dfd59d3b8f390c"
        },
        "date": 1723566873574,
        "tool": "benchmarkdotnet",
        "benches": [
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Root",
            "value": 542538.4584635417,
            "unit": "ns",
            "range": "± 5791.102150743434"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Version",
            "value": 237662.77499112216,
            "unit": "ns",
            "range": "± 2840.801515077488"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Webhook",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5fe873b18a38e49dcaaa846e9178a113f8cc9eee",
          "message": "Update .NET SDK to 9.0.100-rc.1.24414.2 (#1625)\n\n* Update .NET SDK\n\nUpdate .NET SDK to version 9.0.100-rc.1.24414.2.\n\n---\nupdated-dependencies:\n- dependency-name: Microsoft.NET.Sdk\n  dependency-type: direct:production\n  update-type: version-update:semver-patch\n...\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>\n\n* Bump .NET NuGet packages\n\nBumps .NET dependencies to their latest versions for the .NET 9.0.100-rc.1.24414.2 SDK.\n\nBumps Microsoft.AspNetCore.AzureAppServices.HostingStartup from 9.0.0-rc.1.24413.4 to 9.0.0-rc.1.24413.14.\nBumps Microsoft.AspNetCore.Mvc.Testing from 9.0.0-rc.1.24413.4 to 9.0.0-rc.1.24413.14.\nBumps System.Text.Json from 9.0.0-rc.1.24413.3 to 9.0.0-rc.1.24413.14.\n\n---\nupdated-dependencies:\n- dependency-name: Microsoft.AspNetCore.AzureAppServices.HostingStartup\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n- dependency-name: Microsoft.AspNetCore.Mvc.Testing\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n- dependency-name: System.Text.Json\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n...\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>\n\n---------\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>",
          "timestamp": "2024-08-14T10:20:55Z",
          "tree_id": "57e3185dfdd662023c70591b7c840d8a8c94b108",
          "url": "https://github.com/martincostello/costellobot/commit/5fe873b18a38e49dcaaa846e9178a113f8cc9eee"
        },
        "date": 1723631049814,
        "tool": "benchmarkdotnet",
        "benches": [
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Root",
            "value": 546014.0961538461,
            "unit": "ns",
            "range": "± 3988.036581233796"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Version",
            "value": 239881.73970853366,
            "unit": "ns",
            "range": "± 1825.6496593887098"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Webhook",
            "value": 310299.4156901042,
            "unit": "ns",
            "range": "± 1641.115493480344"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e059cf281b61ec41cfe8c371f83d1749c4c01e1f",
          "message": "Consume .NET daily builds\n\nConsume daily builds of .NET 9.",
          "timestamp": "2024-08-14T16:40:42+01:00",
          "tree_id": "0f91b0a0af91f86c57e7c0053d343954e107b625",
          "url": "https://github.com/martincostello/costellobot/commit/e059cf281b61ec41cfe8c371f83d1749c4c01e1f"
        },
        "date": 1723650259706,
        "tool": "benchmarkdotnet",
        "benches": [
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Root",
            "value": 534266.5606770833,
            "unit": "ns",
            "range": "± 4481.107385366477"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Version",
            "value": 238127.98374720983,
            "unit": "ns",
            "range": "± 1551.7193961984005"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Webhook",
      ...
      },
      {
        ...
        "benches": [
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Root",
            "value": 538541.8589564732,
            "unit": "ns",
            "range": "± 3786.5895961244532"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Version",
            "value": 238913.102734375,
            "unit": "ns",
            "range": "± 1631.092786982889"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Webhook",
            "value": 309083.61673177086,
            "unit": "ns",
            "range": "± 944.6671024161501"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c0768be5a4ac52c82841f5f27413840ee1700c66",
          "message": "Update .NET SDK to 9.0.100-rc.1.24414.13 (#1628)\n\n* Update .NET SDK\n\nUpdate .NET SDK to version 9.0.100-rc.1.24414.13.\n\n---\nupdated-dependencies:\n- dependency-name: Microsoft.NET.Sdk\n  dependency-type: direct:production\n  update-type: version-update:semver-patch\n...\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>\n\n* Bump .NET NuGet packages\n\nBumps .NET dependencies to their latest versions for the .NET 9.0.100-rc.1.24414.13 SDK.\n\nBumps Microsoft.AspNetCore.AzureAppServices.HostingStartup from 9.0.0-rc.1.24413.14 to 9.0.0-rc.1.24414.3.\nBumps Microsoft.AspNetCore.Mvc.Testing from 9.0.0-rc.1.24413.14 to 9.0.0-rc.1.24414.3.\n\n---\nupdated-dependencies:\n- dependency-name: Microsoft.AspNetCore.AzureAppServices.HostingStartup\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n- dependency-name: Microsoft.AspNetCore.Mvc.Testing\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n...\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>\n\n---------\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>",
          "timestamp": "2024-08-15T08:16:24Z",
          "tree_id": "de28d9f17969041c91259d4363d58bf2dc943ee5",
          "url": "https://github.com/martincostello/costellobot/commit/c0768be5a4ac52c82841f5f27413840ee1700c66"
        },
        "date": 1723709973286,
        "tool": "benchmarkdotnet",
        "benches": [
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Root",
            "value": 536016.1653645834,
            "unit": "ns",
            "range": "± 4579.337192235836"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Version",
            "value": 236157.56764322918,
            "unit": "ns",
            "range": "± 1722.3005480455677"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Webhook",
            "value": 304969.3741536458,
            "unit": "ns",
            "range": "± 1530.8757089438002"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a5f3f67f2b1d8593de47c688973e9740ad6e494b",
          "message": "Update .NET SDK to 9.0.100-rc.1.24414.26 (#1630)\n\n* Update .NET SDK\n\nUpdate .NET SDK to version 9.0.100-rc.1.24414.26.\n\n---\nupdated-dependencies:\n- dependency-name: Microsoft.NET.Sdk\n  dependency-type: direct:production\n  update-type: version-update:semver-patch\n...\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>\n\n* Bump .NET NuGet packages\n\nBumps .NET dependencies to their latest versions for the .NET 9.0.100-rc.1.24414.26 SDK.\n\nBumps Microsoft.AspNetCore.AzureAppServices.HostingStartup from 9.0.0-rc.1.24414.3 to 9.0.0-rc.1.24414.4.\nBumps Microsoft.AspNetCore.Mvc.Testing from 9.0.0-rc.1.24414.3 to 9.0.0-rc.1.24414.4.\nBumps System.Text.Json from 9.0.0-rc.1.24414.2 to 9.0.0-rc.1.24414.5.\n\n---\nupdated-dependencies:\n- dependency-name: Microsoft.AspNetCore.AzureAppServices.HostingStartup\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n- dependency-name: Microsoft.AspNetCore.Mvc.Testing\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n- dependency-name: System.Text.Json\n  dependency-type: direct:production\n  update-type: version-update:semver-major\n...\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>\n\n---------\n\nSigned-off-by: costellobot <102549341+costellobot@users.noreply.github.com>",
          "timestamp": "2024-08-15T10:20:29Z",
          "tree_id": "f9e12ea44917d1532893fdde6ab60a9e83d6533f",
          "url": "https://github.com/martincostello/costellobot/commit/a5f3f67f2b1d8593de47c688973e9740ad6e494b"
        },
        "date": 1723717411196,
        "tool": "benchmarkdotnet",
        "benches": [
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Root",
            "value": 517420.85013020836,
            "unit": "ns",
            "range": "± 6604.634645710493"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Version",
            "value": 228262.4419921875,
            "unit": "ns",
            "range": "± 5170.139535613564"
          },
          {
            "name": "MartinCostello.Costellobot.Benchmarks.AppBenchmarks.Webhook",
